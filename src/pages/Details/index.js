...
export default class Details extends Component {
  ...
  async getHouseDetail(id) {
    ...
    // console.log(data)
    this.setState({
      // houseInfo: Object.assign(this.state.houseInfo, data)
      houseInfo: data,
      isLoading: false
    })
  ...
  renderDetails() {
    const { isLoading, houseInfo: { community, price, roomType, size, oriented, floor, description, supporting, title } } = this.state
    return (
      <div className={styles.root}>
        ...
        <div className={styles.info}>
          ...
          <Flex className={styles.infoBasic} align="start">
            ...
            <Flex.Item>
              <div>
                <span className={styles.title}>朝向：</span>{oriented.map((item) => item)}
              </div>
              <div>
